Ext.define('MyApp.view.tab.atm.FundAdd', {
    extend: 'Ext.Container',
    xtype: 'tab_atm_fundadd',
    requires: [
                ...
                items: [
                    {
                        ...
                        placeHolder:'Tên quỹ (vd: Quỹ du lịch nước ngoài)',
