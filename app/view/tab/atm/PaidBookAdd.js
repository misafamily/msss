Ext.define('MyApp.view.tab.atm.PaidBookAdd', {
    extend: 'Ext.Container',
    xtype: 'tab_atm_paidbookadd',
    requires: [
                ...
                items: [
                    {
                        ...
                        placeHolder:'Chủ nợ (vd: NGUYEN VAN A)',
                    ...
                    },
                    {
                    ...
                    },
                     {
                        ...
                        readOnly: true,
                        placeHolder:'Ngày mượn 1 Th5 2014',
                        autoCapitalize: false,
                        clearIcon:false
                    },
                     
                    {
	                    xtype: 'textareafield',
						label: '',
	                    placeHolder:'Ghi chú thêm: hạn trả, địa chỉ, số điện thoại chủ nợ',//Note on required pre-tests	                  
	                    cls:'savingadd-note',
						name: 'note',
						maxRows: 3			                    
	                }
