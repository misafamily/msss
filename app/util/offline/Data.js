  ...
  getQuery:function(name, extra){
  	...
  	switch(name){
  			...
  			case 'SavingHistories_Recent':
  				...
  				break;
  			case 'Cashs':
  				queryStr = 'SELECT * FROM expense ORDER BY id DESC'; //WHERE buyingtype="tien_mat"
  				//console.log(queryStr);
  				break;
  			case 'Cashs_Recent':
  				queryStr = 'SELECT * FROM expense ORDER BY id DESC LIMIT 3';//WHERE buyingtype="tien_mat"
  				//console.log(queryStr);
  				break;
  			case 'Expenses_Day':
  				var dd = extra.dd;
